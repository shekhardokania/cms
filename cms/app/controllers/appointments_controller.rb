class AppointmentsController < ApplicationController
  ...
  def get_appointments
    #appointments = Appointment.all
    render :json => current_user.appointments.map {|a| {:id => a.id,:title => a.title,:start => a.start_time.to_i,:end => a.end_time.to_i,:allDay => false,:type => 'follow up',:url => path_for(a)}}
  end
